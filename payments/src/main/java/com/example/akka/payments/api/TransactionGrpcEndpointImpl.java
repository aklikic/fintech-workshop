...
public class TransactionGrpcEndpointImpl implements TransactionGrpcEndpoint {
    ...
    @Override
    public com.example.akka.payments.api.TransactionState getTransaction(GetTransactionRequest request) {
    ...
    private com.example.akka.payments.api.TransactionState toProtoTransactionState(TransactionState state) {
        return com.example.akka.payments.api.TransactionState.newBuilder()
